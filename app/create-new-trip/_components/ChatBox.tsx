...
const ChatBox = () => {
    ...
    const onSend = async () => {
        ...
        try {
            ...
            if (isFinal) {
                // Only save when the AI returned a trip_plan object
                if (data?.trip_plan) {
                    ...
                    try {
                        ...
                        console.log('Saved trip detail:', result)
                    } catch (saveErr) {
                        console.error('Error saving trip detail:', saveErr)
                    }
                } else {
                    console.error('AI did not return trip_plan; skipping SaveTripDetail', data)
                }
            }
        } catch (err) {
            console.error("Error on Responses:", err)
